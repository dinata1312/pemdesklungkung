...
namespace App\Http\Livewire\Post\Notice;
...
class PengumumanModal extends Component
{
    ...
    public function mount()
    {
        ...
        $this->button = create_button($this->action??'create', "Pengumuman");
    }

    public function render()
    {
        return view('livewire.modal.post.pengumuman-modal',[]);
    }

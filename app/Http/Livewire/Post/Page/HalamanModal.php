...
namespace App\Http\Livewire\Post\Page;
...
class HalamanModal extends Component
{
    ...
    public function loadModalContent($refresh = False)
    {
        ...
        $this->button = create_button($this->action, "Halaman");
        switch ($this->action){
            case "create":
    ...
    public function mount()
    {
        ...
        $this->button = create_button($this->action??'create', "Halaman");
    }

    public function render()
    {
        return view('livewire.modal.post.halaman-modal',[]);
    }

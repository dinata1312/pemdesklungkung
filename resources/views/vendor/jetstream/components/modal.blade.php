...
<div
    ...
    x-show="show"
    id="{{ $id }}"
    class="fixed inset-x-0 top-0 z-50 px-4 pt-3 pb-2 sm:px-0 sm:flex sm:items-top sm:justify-center"
    style="display: none;"
>
    ...
    <div x-show="show" class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full {{ $maxWidth }}"
                    ...
                    x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" style="z-index:99999!important">
        {{ $slot }}
    </div>
</div>
